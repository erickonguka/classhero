...
<div class="bg-white dark:bg-gray-900">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 sticky top-24">
                        ...
                        <div class="text-center mb-6">
                            ...
                            @else
                                <div class="text-3xl font-bold text-gray-900 dark:text-white mb-2">${{ $course->price }}</div>
                            @endif
                        </div>
                            ...
                            @elseif($canEnroll)
                                ...
                                @else
                                    <a href="{{ route('payment.checkout', $course) }}" class="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold text-center block transition-colors">
                                        Buy Course - ${{ number_format($course->price, 2) }}
                                    </a>
                                @endif
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-2">
                <!-- Tabs -->
                <div class="border-b border-gray-200 dark:border-gray-700 mb-8" x-data="{ activeTab: 'overview' }">
                ...
                <div x-show="activeTab === 'overview'">
                    ...
                    @if($course->reviews->count() > 0)
                        <div class="mt-12">
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Student Reviews</h3>
                            <div class="space-y-6">
